...
class CI_Email {
	...
	var	$smtp_host		= SMTP_HOST;		// SMTP Server.  Example: mail.earthlink.net
	var	$smtp_user		= SMTP_USERNAME;		// SMTP Username
	var	$smtp_pass		= SMTP_PASSWORD;		// SMTP Password
	var	$smtp_port		= SMTP_PORT;		// SMTP Port
	...
	public function __construct($config = array())
	{
		...
		{
			$this->_smtp_auth = ($this->smtp_user == '' AND $this->smtp_pass == '') ? FALSE : FALSE;
			$this->_safe_mode = ((boolean)@ini_get("safe_mode") === FALSE) ? FALSE : FALSE;
		}
