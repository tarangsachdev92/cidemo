...
<?php echo add_js('jquery.slugify', 'cms', 'modules'); ?>
<div class="main-content">
    <div class="grid-data info-content">
        <div class="add-new">
            <a style="text-align:center;width:100%;" title="View All Country" href="<?php echo base_url().$this->_data['section_name'];?>/states">View all states</a>      </div>
        <div class="tab-nav">
            <ul class="tab-headings clearfix">
                ...
                for ($i = 0; $i < count($languages); $i++) {
                    ...
                    ?><li class="<?php echo $selected; ?>"><a href="javascript:;" rel="#content_<?php echo ($languages[$i]['l']['language_code']); ?>" title="<?php echo $languages[$i]['l']['language_code'];?>">
                    <?php echo $languages[$i]['l']['language_name']; ?></a></li><?php
                }
                ?>
            </ul>
        </div>
...
<script type="text/javascript">
    $(document).ready(function() {
        ...
        $.ajax({
            type: 'POST',
            url: '<?php echo base_url().$this->_data['section_name']; ?>/states/ajax_action/<?php echo $action; ?>/'+lang_code+'/<?php echo $id; ?>',
