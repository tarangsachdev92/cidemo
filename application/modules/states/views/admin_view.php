...
<div class="main-content">
    <div class="grid-data info-content">
        <div class="add-new">
            <?php echo anchor(site_url() . $this->_data['section_name'] . '/states', lang('state_list'), 'title="' . lang('state_list') . '" style="text-align:center;width:100%;"'); ?>
        </div>
        <div class="tab-nav">
...
<script type="text/javascript">
    $(document).ready(function() {
        ...
        load_form = function(lang_code) {
            $.ajax({
                type: 'POST',
                url: '<?php echo base_url() . $this->_data['section_name']; ?>/states/ajax_view/' + lang_code + '/<?php echo $id; ?>',
