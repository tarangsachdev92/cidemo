...
<script type="text/javascript">
    ...
    $(document).ready(function() {
        ...
        openlink = function(type) {
            ...
            location.href= "<?php echo base_url() . $this->_data['section_name']; ?>/blog/action/add/"+lang_code;
        }

         delete_blog = function(id,slug_url)
        {
            ...
            if(res){
                ...
                $.ajax({
                    type:'POST',
                    url:'<?php echo base_url() . $this->_data['section_name']; ?>/blog/delete',
        ...
        load_ajax_index = function(lang_code) {
            ...
            $.ajax({
                type: 'POST',
                url: '<?php echo base_url() . $this->_data['section_name']; ?>/blog/ajax_index/' + lang_code,
