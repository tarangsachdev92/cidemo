...
<?php echo add_js('jquery.slugify', 'country', 'modules'); ?>
<div class="main-content">
    <div class="grid-data info-content">
        <div class="add-new">
            <?php echo anchor(site_url() . $this->_data['section_name'] . '/country', lang('country_list'), 'title="View All Countries" style="text-align:center;width:100%;"'); ?>
        </div>
        <div class="tab-nav">
        ...
        <div class="profile-content-box" id="country_form">
            <!-- Form will come here -->
            <?php echo $content; ?>
        </div>	
    </div>  
...
<script type="text/javascript">
    $(document).ready(function() {
        ...
        load_form = function(lang_code) {
            $.ajax({
                type: 'POST',
                url: '<?php echo base_url() . $this->_data['section_name']; ?>/country/ajax_action/<?php echo $action; ?>/' + lang_code + '/<?php echo $id; ?>',
