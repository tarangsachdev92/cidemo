<div class="main-container">
    <div class="grid-data grid-data-table">        
        <div class="add-new">
            ...
            <a onclick="openlink('add')" style="text-align:center;width:100%;" title="<?php echo lang('add_country'); ?>" href="#"><?php echo lang('add_country'); ?></a>
        </div>        
        <div class="tab-nav">
...
<script type="text/javascript">
    $(document).ready(function() {
        ...
        openlink = function(type) {
            ...
            location.href = "<?php echo base_url() . $this->_data['section_name']; ?>/country/action/add/" + lang_code;
        }

        delete_country = function(id, country_id, country_name)
        {
            ...
            if (res) {
                ...
                $.ajax({
                    type: 'POST',
                    url: '<?php echo base_url() . $this->_data['section_name']; ?>/country/delete',
                    data: {<?php echo $csrf_token; ?>: '<?php echo $csrf_hash; ?>', id: id, country_id: country_id, country_name: country_name},
        ...
        load_ajax_index = function(lang_code) {
            ...
            $.ajax({
                type: 'POST',
                url: '<?php echo base_url() . $this->_data['section_name']; ?>/country/ajax_index/' + lang_code,
