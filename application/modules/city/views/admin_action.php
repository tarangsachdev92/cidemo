...
<?php echo add_js('jquery.slugify', 'banner', 'modules', 'common'); ?>
...
<script type="text/javascript">    
    $(document).ready(function() {
        ...
        $.ajax({
            type: 'POST',
            url: '<?php echo base_url().$this->_data['section_name']; ?>/city/ajax_action/<?php echo $action; ?>/'+lang_code+'/<?php echo $id; ?>',
