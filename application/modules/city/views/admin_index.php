<div class="main-container">    
    <div class="grid-data grid-data-table">        
        <div class="add-new">
            ...
            <a onclick="openlink('add')" style="text-align:center;width:100%;" title="<?php echo lang('add_city');?>" href="#"><?php echo lang('add_city');?></a>
        </div>        
        <div class="tab-nav">
...
<script type="text/javascript">    
    $(document).ready(function() {        
        ...
        openlink = function(type){
            ...
            location.href= "<?php echo base_url().$this->_data['section_name']; ?>/city/action/add/"+lang_code;
        }
        ...
        delete_city = function(id)
        {
            ...
            if(res)               
            {
                ...
                $.ajax({
                    type:'POST',
                    url:'<?php echo base_url().$this->_data['section_name']; ?>/city/delete',
        ...
        load_ajax_index = function(lang_code) {  
            ...
            $.ajax({
                type: 'POST',
                url: '<?php echo base_url().$this->_data['section_name']; ?>/city/ajax_index/' + lang_code,
