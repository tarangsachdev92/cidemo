<div class="main-container">
    <div class="grid-data grid-data-table">
        <div class="add-new">
            ...
            <span style="float:right"><?php echo anchor(site_url() . $this->_data["section_name"] . '/shoppingcart/action_payments/add', lang('add_payments'), 'title="' . lang('add_payments') . '" style="text-align:center;width:100%;"'); ?></span>
        </div>
...
<script type="text/javascript">
    ...
    $(document).ready(function() {
        ...
        openlink = function(type) {
            ...
            location.href = "<?php echo base_url() . $this->_data['section_name']; ?>/shoppingcart/action_payments/add";
        }

        delete_payments = function(id, slug_url)
        {
            ...
            if (res) {
                ...
                $.ajax({
                    type: 'POST',
                    url: '<?php echo base_url() . $this->_data['section_name']; ?>/shoppingcart/delete_payments',
