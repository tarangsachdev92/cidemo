<div class="main-container">
    <div class="grid-data grid-data-table">
        <div class="add-new">
            ...
            <a onclick="openlink('add')" style="text-align:center;width:100%;" title="<?php echo lang('add_prd'); ?>" href="#"><?php echo lang('add_prd'); ?></a>
        </div>
        <div class="tab-nav">
...
<script type="text/javascript">
                ...
                $(document).ready(function() {
                    ...
                    openlink = function(type) {
                        ...
                        location.href = "<?php echo base_url() . $this->_data['section_name']; ?>/shoppingcart/action/add/" + lang_code;
                    }
                    ...
                    delete_product = function(id, slug_url)
                    {
                        ...
                        if (res) {
                            ...
                            $.ajax({
                                type: 'POST',
                                url: '<?php echo base_url() . $this->_data["section_name"]; ?>/shoppingcart/delete',
                    ...
                    load_ajax_index = function(lang_code) {
                        ...
                        $.ajax({
                            type: 'POST',
                            url: '<?php echo base_url() . $this->_data["section_name"]; ?>/shoppingcart/ajax_products_index/' + lang_code,
