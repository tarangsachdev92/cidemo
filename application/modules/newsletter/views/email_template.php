...
<html>
    <head>
        ...
        <style type="text/css">
            ...
            body { background-color: #626266; margin: 0; padding: 0; }
                ...
                <tr>
                    <td align="center" bgcolor="#626266">
                        <table class="w640" style="margin:0 10px;" border="0" cellpadding="0" cellspacing="0" width="640">
                            <tbody>
                                <tr><td class="w640" height="20" width="640"></td></tr>
                                <tr>
                                                ...
                                                <tr>
                                                    ...
                                                    <td class="w325" align="left" valign="middle" width="350">
                                                        <table class="w325" border="0" cellpadding="0" cellspacing="0" width="350">
                                                            <tbody>
                                                                <tr><td class="w325" height="8" width="350"></td></tr>
                                                            </tbody>
                                                        </table>
                                                        <table class="w325" border="0" cellpadding="0" cellspacing="0" width="350">
                                                            <tbody>
                                                        ...
                                                        <table border="0" cellpadding="0" cellspacing="0">
                                                            <tbody>
                                                                <tr>
                                                                    ...
                                                                    <td width="3"></td>
                                                                    <td valign="middle">
                                                                        <div class="header-content"><fblike>Like</fblike></div>
                                                                    </td>
                                                ...
                                                <tr>
                                                    ...
                                                    <td class="w580" width="580">
                                                        <div id="headline" align="center">
                                                            <p>
                                                                <strong><singleline label="Title">Welcome to Cidemo - Newsletter</singleline></strong>
                                                            </p>
                                                        </div>
                                                    </td>
                                                    <td class="w30" width="30"></td>
                                                            ...
                                                            <layout label="Text only">
                                                                <table class="w580" border="0" cellpadding="0" cellspacing="0" width="580">
                                                                    <tbody>
                                                                        <tr>
                                                                            <td class="w580" width="580">
                                                                                <p class="article-title" align="left"><singleline label="Title">Your Details</singleline></p>
