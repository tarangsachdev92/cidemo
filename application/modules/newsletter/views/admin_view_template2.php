...
<html>
    <head>
        ...
        <style type="text/css">
            ...
            /* Webkit Elements */
            #top-bar { border-radius:6px 6px 0px 0px; -moz-border-radius: 6px 6px 0px 0px; -webkit-border-radius:6px 6px 0px 0px; -webkit-font-smoothing: antialiased; background-color: #B795BD; color: #7f8c4f; }
...
<body>
        <table id="background-table" border="0" cellpadding="0" cellspacing="0" width="100%">
            <tbody>
                <?php if ($view == '1') { ?>
                <tr><button onclick="history.go(-1);" style="float: right;margin-bottom: 10px;" class="inputbutton" title="Back" type="button" name="">Back</button></tr>
                <?php } ?>
                <tr>
                    <td align="center" bgcolor="#626266">
                        <table class="w640" style="margin:0 10px;" border="0" cellpadding="0" cellspacing="0" width="640">
                                <tbody><tr><td class="w640" height="20" width="640"></td></tr>
                                    ...
                                    <tr>
                                        <td id="header" class="w640" align="center" bgcolor="#C7D9D7" width="640">
                                            ...
                                            <tbody>
                                                ...
                                                <tr>
                                                    ...
                                                    <td class="w580" valign="top" width="360">
                                                        <span class="hide"><p id="permission-reminder" class="footer-content-left" align="left"><span>Copyright © 2000-2011 TatvaSoft </span></p></span>
                                                        <?php if ($view != '1') { ?>
