<style type="text/css">
            ...
            #background-table { background-color: #626266; }
            /* Webkit Elements */
            #top-bar { border-radius:6px 6px 0px 0px; -moz-border-radius: 6px 6px 0px 0px; -webkit-border-radius:6px 6px 0px 0px; -webkit-font-smoothing: antialiased; background-color: #363540; color: #7f8c4f; }
            #top-bar a { font-weight: bold; color: #7f8c4f; text-decoration: none;}
            #footer { border-radius:0px 0px 6px 6px; -moz-border-radius: 0px 0px 6px 6px; -webkit-border-radius:0px 0px 6px 6px; -webkit-font-smoothing: antialiased; }
            .header-content, .footer-content-left, .footer-content-right { -webkit-text-size-adjust: none; -ms-text-size-adjust: none; }
            /* Prevent Webkit and Windows Mobile platforms from changing default font sizes on header and footer. */
            .header-content { font-size: 12px; color: #7f8c4f; }
            .header-content a { font-weight: bold; color: #7f8c4f; text-decoration: none; }
            ...
            .article-title { font-size: 18px; line-height:24px; color: #526f92; font-weight:bold; margin-top:0px; margin-bottom:18px; font-family: HelveticaNeue, sans-serif; }
            .article-title a { color: #526f92; text-decoration: none; }
    ...
    <div class="row">        
        <div class="col-md-12">
            <div class="panel-header clearfix">
               ...
               <?php if ($view == '1') { ?>
                <tr><a onclick="history.go(-1);"  class="add-link" title="Back" type="button" name="">View Newsletters</a></tr>
                <?php } ?>
            </div>
            ...
            <tbody>
                ...
                <tr>
                    <td align="center" bgcolor="#626266">
                        <table class="w640" style="margin:0 10px;" border="0" cellpadding="0" cellspacing="0" width="640">
                                <tbody><tr><td class="w640" height="20" width="640"></td></tr>
                                    <tr>
                                        <td class="w640" width="640">
                                            <table id="top-bar" class="w640" bgcolor="#b4bf8a" border="0" cellpadding="0" cellspacing="0" width="640">
                                                <tbody>
                                                    <tr>
                                                        ...
                                                        <td class="w255" align="right" valign="middle" width="255">
                                                            ...
                                                            <table border="0" cellpadding="0" cellspacing="0">
                                                                <tbody>
                                                                    <tr>
                                                                        ...
                                                                        <td class="w10" width="10"></td>
                                                                        <td valign="middle"><forwardtoafriend lang="en"><img src="https://img.createsend1.com/img/templatebuilder/forward-glyph.png" alt="Forward icon"="" border="0" height="14" width="19"></forwardtoafriend></td>
                                                                        <td width="3"></td>
                                                            ...
                                                            <table class="w255" border="0" cellpadding="0" cellspacing="0" width="255">
                                                                <tbody>
                                                                    <tr><td class="w255" height="8" width="255"></td></tr>
                                                                </tbody>
                                                            </table>
                                                        </td>
                                                        <td class="w15" width="15"></td>
                                    ...
                                    <tr>
                                        <td id="header" class="w640" align="center" bgcolor="#b4bf8a" width="640">
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td class="w580" width="580">
                                                            <div id="headline" align="center">
                                                                <p>
                                                                    <strong><singleline label="Title"><?= $title; ?></singleline></strong>
                                                                </p>
                                                            </div>
                                                        </td>
                                                        <td class="w30" width="30"></td>
                                                            ...
                                                            <layout label="Text only">
                                                                <table class="w580" border="0" cellpadding="0" cellspacing="0" width="580">
                                                                    <tbody>
                                                                        <tr>
                                                                            <td class="w580" width="580">
                                                                                <p class="article-title" align="left"><singleline label="Title"><?php echo $subject; ?></singleline></p>
                                                                                <div class="article-content" align="left">
                                                                                    <multiline label="Description"><?php echo html_entity_decode ($text); ?></multiline>
                                                                                </div>
                                                                            </td>
                                                                        </tr>
                                ...
                                <tr>
                                    <td class="w640" width="640">
                                        <table id="footer" class="w640" bgcolor="#4e4c59" border="0" cellpadding="0" cellspacing="0" width="640">
                                            <tbody>
                                                <tr><td class="w30" width="30"></td><td class="w580 h0" height="30" width="360"></td><td class="w0" width="60"></td><td class="w0" width="160"></td><td class="w30" width="30"></td></tr>
                                                <tr>
                                                    <td class="w30" width="30"></td>
                                                    <td class="w580" valign="top" width="360">
                                                        <span class="hide"><p id="permission-reminder" class="footer-content-left" align="left"><span>Copyright Â© 2000-2011 TatvaSoft </span></p></span>
                                                        <?php if ($view != '1') { ?>
                                                            <p class="footer-content-left" align="left"><unsubscribe><a href="<?php echo base_url (); ?>newsletter/unsubscribe/<?php echo $user_id; ?>" >Unsubscribe</a></unsubscribe></p>
                                                        <?php } ?>
                                                    </td>
