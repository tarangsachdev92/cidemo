                ...
                <tr>
                    <td width="100%" valign="top">
                        ...
                        <table width="100%" cellpadding="5" cellspacing="1" border="0">
                            ...
                            ?>
                           <!-- <textarea name="q_ans" rows="3" cols="55" maxlength="100" style="resize: none;" onkeyup="new do_resize(this);" onKeyPress="return ( this.value.length < 100);" onpaste="return ( this.value.length < 100);"></textarea>-->
                            <tr>
