    ...
    <div class="contentpanel">
        ...
        <div class="row">        
            <div class="col-md-12">
                ...
                <a class="add-link" href="javascript:;" onclick="openlink('add')" title="<?php echo lang('add_cms');?>"><?php echo lang('add_cms');?></a>
            </div>
                            ...
                            <div class="table-responsive">          		
                                <table class="table table-hover gradienttable">
                                    ...
                                    <th>
                                        ...
                                        <a href="javascript:;" onclick="sort_data('c.title', '<?php echo $field_sort_order; ?>');" class="wht-fnt" title="Sort by Title"><?php echo lang('title'); ?>&nbsp;&nbsp;&nbsp;<?php
                                            if ($sort_by == 'c.title') {
                                                echo $sort_image;
                                            }
                                            ?></a>
                                    ...
                                    <tbody>
                                        ...
                                        foreach ($cms_list as $cms_page) {
                                            ...
                                            <tr>
                                                <td>
                                                    <div class="ckbox ckbox-default">
                                                        <input type="checkbox" id="<?php echo $cms_page['c']['id']; ?>" name="check_box[]" class="check_box" value="<?php echo $cms_page['c']['id']; ?>">
                                                ...
                                                <td class="t-center"><?php echo $cms_page['c']['modified']; ?></td>


                                                <td class="t-center">

                                                    <a class="mr5" href="<?php echo site_url() . $this->_data['section_name']; ?>/cms/view/<?php echo $cms_page['l']['language_code'] . "/" . $cms_page['c']['cms_id']; ?>" title="View CMS"><i class="fa fa-eye"></i></a>

                                                    <a class="mr5" href="<?php echo site_url() . $this->_data['section_name']; ?>/cms/action/edit/<?php echo $cms_page['l']['language_code'] . "/" . $cms_page['c']['cms_id']; ?>" title="Edit CMS"><i class="fa fa-pencil"></i></a>

                                                    <a class="delete-row" href="javascript:;" onclick="delete_cms('<?php echo $cms_page['c']['id']; ?>', '<?php echo $cms_page['c']['slug_url']; ?>')"><i class="fa fa-trash-o" title="Delete CMS"></i></a>
                                            ...
                                            $.ajax({
                                                ...
                                                url: '<?php echo base_url() . $this->_data['section_name']; ?>/cms/ajax_index/<?php echo $language_code; ?>',
                                                            ...
                                                            success: function(data) {
                                                                ...
                                                                ajaxLink('<?php echo base_url() . $this->_data['section_name']; ?>/cms/ajax_index/<?php echo $language_code; ?>', 'contentpanel', '<?php echo $querystr; ?>' + pageno);
