...
<script type="text/javascript">
    ...
    $(document).ready(function() {
        ...
        openlink = function(type) {
            ...
            location.href = "<?php echo base_url() . $this->_data['section_name']; ?>/cms/action/add/" + lang_code;
        };
        ...
        load_ajax_index = function(lang_code) {
            ...
            $.ajax({
                type: 'POST',
                url: '<?php echo base_url() . $this->_data['section_name']; ?>/cms/ajax_index/' + lang_code,
