                    ...
                    <tr>
                        <td width="100%" valign="top">
                            <table width="100%" cellpadding="4" cellspacing="1" border="0">
                                ...
                                <tr>
                                    <td>
                                        <span class="star">*&nbsp;</span><?php echo lang('title'); ?>
                                    </td>
                                    <?php
                                    $event_title = array(
                                        'name' => 'event_title',
                                    ...
                                    <td colspan="2"><?php echo form_input($event_title); ?>
                                        <br/><span class="warning-msg"><?php echo form_error('event_title'); ?>
                                    </td>
                                </tr>
                                <tr >
                                    <td>
                                        <span class="star">*&nbsp;</span><?php echo lang('event_desc'); ?>
                                    </td>
                                    <?php
                                    $event_desc = array(
                                        'style' => 'resize:none',
                                    ...
                                    <td colspan="2"><?php echo form_textarea($event_desc); ?>
                                        <br/><span class="warning-msg"><?php echo form_error('event_desc'); ?>
                                    </td>
                                </tr>
                                <tr class="date">
                                    <td>
                                        <span class="star">*&nbsp;</span><?php echo lang('start'); ?>
                                    </td>
                                    <?php
                                    $start_date = array(
                                        'name' => 'start_date',
                                    ...
                                    ?>
                                    <td><?php echo form_input($start_date); ?>
                                        <br/><span class="warning-msg"><?php echo form_error('start_date'); ?>
                                    </td>
                                    <?php
                                    $start_time = array(
                                        '00:00:00' => '12:00AM',
                                ...
                                <tr class="date">
                                    ...
                                    ?>
                                    <td><?php echo form_input($end_date); ?>
                                        <br/><span class="warning-msg"><?php echo form_error('end_date'); ?>
                                    </td>
                                    <?php
                                    $end_time = array(
                                        '00:00:00' => '12:00AM',
                                ...
                                <tr>
                                    ...
                                    ?>
                                    <td colspan="2"><?php echo form_input($event_loc); ?>
                                        <br/><span class="warning-msg"><?php echo form_error('event_loc'); ?>
                                    </td>
                                </tr>
                                ...
                                <tr>
                                    ...
                                    ?>
                                    <td colspan="2">
                                    <?php echo form_input($event_org); ?>
                                        <br/><span class="warning-msg"><?php echo form_error('event_org'); ?>
                                    </td>
                                </tr>
                                <tr>
                                    ...
                                    <td colspan="2"><?php echo form_input($event_fees); ?>
                                        <br/><span class="warning-msg"><?php echo form_error('event_fees'); ?>
                                    </td>
                                </tr>
                                <tr>
                                ...
                                <tr>
                                        ...
                                        if (isset($cal['repeated']))
                                        {
                                            if ($cal['repeated'] == NOT_REPEATED)
                                            {
                                                ...
                                                echo form_radio(array(
                                                    ...
                                                    "id" => "is_repeat",
                                                    "value" => NOT_REPEATED,
                                                    'checked' => set_radio('repeat', 'never', TRUE),
                                                    "onclick" => "hideShowGroup()"));
                                                echo lang('never');
                                                echo form_radio(array(
                                                    "name" => "is_repeat",
                                                    "id" => "is_repeat",
                                                    "value" => REPEATED,
                                                    'checked' => set_radio('repeat', 'specific_date', FALSE),
                                                    "onclick" => "hideShowGroup()")
                                                );
                                            ...
                                            else
                                            {
                                                ...
                                                echo form_radio(array(
                                                    ...
                                                    "id" => "is_repeat",
                                                    "value" => NOT_REPEATED,
                                                    'checked' => set_radio('repeat', 'never', FALSE),
                                                    "onclick" => "hideShowGroup()")
                                                );
                                                echo lang('never');
                                                echo form_radio(array(
                                                    ...
                                                    "id" => "is_repeat",
                                                    "value" => REPEATED,
                                                    'checked' => set_radio('repeat', 'specific_date', TRUE),
                                                    "onclick" => "hideShowGroup()")
                                                );
                                                echo lang('repeat_event_end_date');
                                            }
                                    ...
                                    <td>
                                                ...
                                                <table>
                                                    <tr>
                                                        <td>
                                                            <span>&nbsp;&nbsp;&nbsp;</span><?php echo lang('privacy'); ?>
                                                        </td>
                                                        <td>
                                                            <?php
                                                            if (isset($cal['privacy']))
                                                            {
                                                                if ($cal['privacy'] == PUBLIC_EVENT)
                                                                {
                                                                    echo form_radio(array(
                                                                        "name" => "privacy",
                                                                        "id" => "private",
                                                                        "value" => PRIVATE_EVENT,
                                                                        'checked' => set_radio('privacy', 'private', FALSE)));
                                                                    echo form_label('Private');
                                                                    echo form_radio(array(
                                                                        "name" => "privacy",
                                                                        "id" => "public",
                                                                        "value" => PUBLIC_EVENT,
                                                                        'checked' => set_radio('privacy', 'public', TRUE)));
                                                                    echo form_label('Public');
                                                                }
                                                                else
                                                                {
                                                                    echo form_radio(array(
                                                                        ...
                                                                        "id" => "private",
                                                                        "value" => PRIVATE_EVENT,
                                                                        'checked' => set_radio('privacy', 'private', TRUE)));
                                                                    echo form_label('Private');
                                                                    echo form_radio(array(
                                                                        "name" => "privacy",
                                                                        "id" => "public",
                                                                        "value" => PUBLIC_EVENT,
                                                                        'checked' => set_radio('privacy', 'public', FALSE)));
                                                                    echo form_label('Public');
                                                                }
                                                            }
                                                            else
                                            ...
                                            <div class="submit-btns clearfix">
                                                ...
                                                {
                                                    $cancel = array(
                                                        'name' => lang('btn-cancel'),
                                                        'id' => lang('btn-cancel'),
                                                        'content' => lang('btn-cancel'),
                                                        'title' => lang('btn-cancel'),
                                                        'class' => 'inputbutton',
                                                        'onclick' => "location.href='" . site_url($section_name . '/calendar') . "'",);
                                                }
                                                else
                                                {
                                                    $cancel = array(
                                                        ...
                                                        'title' => lang('btn-cancel'),
                                                        'class' => 'inputbutton',
                                                        'onclick' => "location.href='" . site_url($section_name . '/calendar/event_list/' . $language_code) . "'",);
                                                }
                                                echo "&nbsp;";
                                            ...
                                            { ?>
                                                <script type ="text/javascript">
                                                    function validate_field()
                                                    {
                                                        ...
                                                        $.ajax({
                                                            type: 'POST',
                                                            url: '<?php echo base_url(); ?><?php echo $section_name; ?>/calendar/validate/<?php echo $language_code; ?>',
                                                            ...
                                                            success: function(data) {
                                                                if (data == 1)
                                                                {
                                                                    $.ajax({
                                                                        type: 'POST',
                                                                        url: '<?php echo base_url(); ?><?php echo $section_name; ?>/calendar/action/<?php echo $action; ?>/<?php echo $type; ?>/<?php echo $language_code; ?>/<?php echo $id; ?>',
                                                                        data: $("#caladd").serialize(),
                                                                        success: function(data) {                                                                              
                                                                            location.href = "<?php echo base_url(); ?><?php echo $section_name; ?>/calendar";
                                                                        }
                                                            ...
                                                            success: function(data) {
                                                                if (data == '1')
                                                                {
                                                                    $.ajax({
                                                                        ...
                                                                        data: $("#caladd").serialize(),
                                                                        success: function(data) {
                                                                            location.href = "<?php echo base_url(); ?><?php echo $section_name; ?>/calendar/event_list/<?php echo $language_code; ?>";
                                                                        }
                                                                    });
                                                                }
                                                                if (data !== '1')
