<?php echo add_css(array('fullcalendar', 'fullcalendar.print', 'jquery-ui'), 'calendar', 'modules'); ?>
<?php echo add_js(array('fullcalendar.min', 'jquery-ui'), 'calendar', 'modules'); ?>
<div>
    <!-- encode the data for displaying in to calendar -->
    <?php $data_array = json_encode($data['event_list']); ?>
</div>
<script type="text/javascript">
    $(document).ready(function()
    {
        ...
        $('#calendarmain').fullCalendar(
        {
            ...
            buttonText: {
                today: '<a href = "<?php echo base_url(); ?><?php echo $data['section_name']; ?>/calendar/event_list/<?php echo $data['language_code']; ?>" style = "text-decoration: none; color: black; "> <?php echo lang('event_list'); ?> </a>'
            },
            monthNames:["<?php echo lang('january'); ?>", "<?php echo lang('february'); ?>", "<?php echo lang('march'); ?>", "<?php echo lang('april'); ?>", "<?php echo lang('may'); ?>", "<?php echo lang('june'); ?>", "<?php echo lang('july'); ?>", "<?php echo lang('august'); ?>", "<?php echo lang('september'); ?>", "<?php echo lang('october'); ?>", "<?php echo lang('november'); ?>", "<?php echo lang('december'); ?>"],
            monthNamesShort:["<?php echo lang('january'); ?>", "<?php echo lang('february'); ?>", "<?php echo lang('march'); ?>", "<?php echo lang('april'); ?>", "<?php echo lang('may'); ?>", "<?php echo lang('june'); ?>", "<?php echo lang('july'); ?>", "<?php echo lang('august'); ?>", "<?php echo lang('september'); ?>", "<?php echo lang('october'); ?>", "<?php echo lang('november'); ?>", "<?php echo lang('december'); ?>"],
            dayNames:["<?php echo lang('monday'); ?>", "<?php echo lang('tuesday'); ?>", "<?php echo lang('wednesday'); ?>", "<?php echo lang('thursday'); ?>", "<?php echo lang('friday'); ?>", "<?php echo lang('saturday'); ?>", "<?php echo lang('sunday'); ?>"],
            ...
            select: function(start, end) {
                ...
                $($dialog).dialog(
                {
                  ...
                  //  left: 200,
                    top: 200,
                    close: function(event, ui) { location.href = '<?php echo site_url(); ?><?php echo $data['section_name']; ?>/calendar' }
                }
            );
            },
            ...
            eventClick: function(event) {
                $('#edit').load('calendar/event_detail/<?php echo $data['language_code']; ?>/' + event.id).dialog(
                {                    
                    width: 700,
                    draggable: false,
...
<table>
    <tr>
        <td>
            <span style="font-size: medium"><?php echo lang('jump_to_date'); ?>:</span>
            <div style="width: 280px; height:240px;" id="miniCalendar"></div>
            <span style="font-size: medium"><?php echo lang('upcoming_events'); ?>:</span>
            <div id= "accordion" style="width: 280px; height: 450px;"></div>
            <div id="edit"> </div>
        </td>
        <td>
            <table> <tr><td><div  id= "calendarmain" style = " width:875px; float:left; padding-left:10px; padding-bottom: 20px;"></div></td></tr></table>
        </td>
    </tr>
</table>
