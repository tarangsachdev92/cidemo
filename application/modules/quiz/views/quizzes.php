<div class="main-container">
    ...
    if($msg_no_category_records != '')
    {
        ...
        echo "<br>".anchor(base_url().$this->_data['section_name']."/quiz/quizzes_action/add", lang('add_new_quizzes'));
    }
    else
    {
    ?>
    <div class="grid-data grid-data-table">
        <div class="add-new">
            ...
            <?php echo anchor(base_url().$this->_data['section_name']."/quiz/quizzes_action/add/".$language_code, lang('add_new_quizzes')); ?>
        </div>
        <div class="tab-nav">
    ...
    $(document).ready(function() {
        ...
        delete_record = function(id)
        {
            ...
            if(res)
            {
                ...
                $.ajax({
                    type:'POST',
                    url:'<?php echo base_url().$this->_data['section_name']; ?>/quiz/delete_quizzes/',
        ...
        load_ajax_index = function(lang_code) {
            ...
            $.ajax({
                type: 'POST',
                url: '<?php echo base_url().$this->_data['section_name']; ?>/quiz/ajax_quizzes_list/' + lang_code,
