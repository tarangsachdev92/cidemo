    ...
    <div class="main-container">
        ...
        <div class="search-box">
            <table cellspacing="2" cellpadding="4" border="0">
                <tbody>
                    <tr>
                        <td align="right"><?php echo lang('search_by_question') ?> :</td>
                        <?php
                        $input_data = array(
                            'name' => 'search_term',
                            'id' => 'search_term',
        ...
        <table cellspacing="1" cellpadding="4" border="0" bgcolor="#e6ecf2" width="100%">
                ...
                <tr>
                    ...
                    <th>
                        <?php
                            ...
                            if($sort_by == 'qq.question' && $sort_order == 'asc')
                            {
                                $sort_image = 'srt_up.png';
                                $field_sort_order = 'desc';
                            }
                        ?>
                        <a href="javascript:void(0)" onclick="sort_data('qq.question', '<?php echo $field_sort_order;?>');" >
                            <?php echo lang('question'); ?>
                            <?php if($sort_by == 'qq.question')
                            {
                                ?>
                                <div class="sorting">
                ...
                foreach ($listing_data as $details)
                {
                    ...
                    <tr class="<?php echo $class; ?>">
                        ...
                        <td>
                            <div class="action">
                                <div class="edit">
                                    <a href="<?php echo base_url().$this->_data['section_name']; ?>/quiz/question_action/edit/<?php echo $details['l']['language_code'] . "/" . $details['qq']['question_id']; ?>" title="<?php echo lang('edit'); ?>">
                                        <?php echo add_image(array('edit.png')); ?>
                                    </a>
                                </div>

                                <div class="delete">
                                    <a href='javascript:;' title='<?php echo lang('delete'); ?>' onclick="delete_record('<?php echo $details['qq']['question_id']; ?>')">
            ...
            $options = array(
                ...
                'isAjaxRequest' => 1,
                'base_url' => base_url().$this->_data['section_name']."/quiz/ajax_questions_list/" . $language_code,
...
<script>
    ...
    {
        if ($('#search_term').val() == '') {
        $('#search_term').validationEngine('showPrompt', '<?php echo lang('question_required'); ?>', 'error');
        ...
        $.ajax({
            type: 'POST',
            url: '<?php echo base_url().$this->_data['section_name']; ?>/quiz/ajax_questions_list/<?php echo $language_code; ?>',
