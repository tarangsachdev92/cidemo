<div class="main-container">
    ...
    <div class="profile-content-box" id="testimonial_form">
       <?php echo $content; ?>
...
<script type="text/javascript">
    $(document).ready(function() {
        ...
        load_form = function(lang_code) {
            ...
            $.ajax({
            type: 'POST',
            url: '<?php echo base_url(); ?><?php echo $section_name;  ?>/testimonial/ajax_action/<?php echo $action; ?>/'+lang_code+'/<?php echo $testimonial_id; ?>',
