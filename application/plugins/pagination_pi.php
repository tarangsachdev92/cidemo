...
{    
    ...
    $obj->load->library('my_pagination');
    ...
    $obj->my_pagination->initialize($config); 
    
    return $obj->my_pagination->create_links();
    // end paging
}
...
//    echo "Perpage in validateperpage: ".$per_page."<Br />";
 ...
 * @return unknown
 */
function get_offset($page_number, $per_page_val = 0)
{
    //$obj =& get_instance();
//    echo "Cur Page:".$cur_page_seg."<br />";
//    echo "Per Page Val :".$per_page_val."<br />";
    ...
    if(!$per_page_val)
        $per_page_val = 5;//$this->session->userdata['admin']['record_per_page'];
